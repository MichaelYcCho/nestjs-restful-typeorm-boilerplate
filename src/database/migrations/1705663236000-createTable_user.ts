...
export class CreateTableUser1705884155700 implements MigrationInterface {
    name = 'CreateTableUser1705884155700'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_user_role_enum" AS ENUM('0', '1', '2')`)
